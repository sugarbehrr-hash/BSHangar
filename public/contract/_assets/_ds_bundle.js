...
// deploy/templates/cba-vote/assessment-charts.js
try { (() => {
/*
 * assessment-charts.js — the ONE chart renderer for the vote guide.
 * window.AssessmentChart(spec, opts) -> SVG string, where spec is an entry from
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "deploy/templates/cba-vote/assessment-charts.js", error: String((e && e.message) || e) }); }

// deploy/templates/cba-vote/assessment.data.js
try { (() => {
/*
 * ============================================================================
 *  assessment.data.js — SINGLE SOURCE OF TRUTH for the contract vote guide.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "deploy/templates/cba-vote/assessment.data.js", error: String((e && e.message) || e) }); }

// deploy/templates/cba-vote/card-render.js
try { (() => {
/* ============================================================================
 * card-render.js — SHARED card design language for the TA Vote Guide.
 *
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "deploy/templates/cba-vote/card-render.js", error: String((e && e.message) || e) }); }

// deploy/templates/cba-vote/ds-base.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "deploy/templates/cba-vote/ds-base.js", error: String((e && e.message) || e) }); }
