...
window.ASSESSMENT = {
  "renderContract": {
    ...
    "you_must": [
      ...
      "If a chart's x-axis has showAllTicks:true, EVERY tick label from axes.x.ticks must appear - the shipped renderer already draws them all (rotating when crowded) and the build's render-contract gate fails if any is missing. Do not thin, skip, or sample them. Thinning the axis misrepresents where step changes occur (e.g. makes a raise at the 3-year rung look like it lands at year 2).",
      ...
      "If a chart has chart.highlightRange, shade the background across the x-categories at those indexes (a red-tinted band across those bars/points) and place its label as a callout pointing at that band - this marks the specific range where the story concentrates (e.g. 'these step raises were removed').",
      "For a chart with chart.highlightable (group keys), render group buttons that HIGHLIGHT the chosen group's line and dim the others - all lines stay visible, nothing is removed. The chart.breakeven series is the reference line: a pay line ABOVE it is gaining ground, BELOW it is losing.",
      "REGISTER FILTERING (collections): the website build shows ONLY items whose register is 'web' or 'both'; the PDF build shows ALL. This governs marketCards[] (each has register 'web'|'pdf') and tables[] (register 'web'|'pdf'|'both'). The website must render only the ~4 web-tagged market cards, NOT all 11 — showing the full set on the website is a bug. Do not treat register as advisory.",
      "REGISTER PROSE: website renders each item's `plain` and each chart's `plainCaption`; the PDF renders `meaning`/`realterms` and `headline`. NEVER fall back from `plain` to `meaning` on the website — if `plain` is missing that is a skill bug to report, not a reason to leak the technical register onto the member-facing page.",
      ...
      "Do NOT render any section whose key is not in page_order (e.g. a retired 'find your position' section). A section absent from page_order is retired; show nothing for it. Read the group-specific outlook from the scoreboard instead."
    ],
    "you_must_not": [
  ...
  "meta": {
    ...
    "version": "1.25.17",
    "generator": "contract-vote-analyzer v1.25.17",
    ...
    "methodology": {
      ...
      "anchorsIntro": "Five things keep every rating honest:",
      "anchors": [
        {
  ...
  "topics": [
    {
      ...
      "changes": [
        ...
        },
        {
          ...
          "meaning": "The genuine win for new hires: you start ~$10/hr above the old scale and the company can no longer cut junior rates. But keep it in perspective - this was market-forced (a regional cannot hire at $20 when mainline starts at $36), not generosity.",
          "realterms": null,
          "rating": {
            "nh": "sg",
            "mc": "nc",
        ...
        },
        {
          ...
          "type": "NEW",
          "starts": "Carve-outs at DOR; 3.75 hrs 3/6/2028",
          "delivery": "delayed",
          "cond": null,
          "market": null,
          "today": "3.5 hours per calendar day, and certain 'carve-outs' reduce it in some situations.",
          "proposed": "Carve-outs removed at ratification; the 3.5-hour minimum rises to 3.75 hours on 3/6/2028.",
        ...
        },
        {
          ...
          "title": "Deadhead pay",
          "type": "NEW",
          "starts": "Some at DOR; 75% at 3/6/2028",
          "delivery": "delayed",
          "cond": null,
          "market": null,
          "today": "Deadhead pays 100% of the time flown; a deadhead on a day off carries only a 2.5-hour minimum.",
          "proposed": "A full deadhead day pays no less than minimum-day pay; deadhead on a day off also gets that floor; 'selfing' pay/per diem now covers deadheads TO duty, not just from; rate rises to 75% pay and credit on 3/6/2028.",
    ...
    },
    {
      ...
      "changes": [
        ...
        },
        {
          ...
          "meaning": "Not new money — a benefit you already have becomes permanent. Don't count it as a fresh win.",
          "realterms": null,
          "rating": {
            "nh": "nc",
            "mc": "nc",
    ...
    },
    {
      ...
      "changes": [
        ...
        },
        {
          ...
          "proposed": "A 3-year term (3/6/2026-3/6/2029).",
  ...
  "charts": [
    {
      ...
      "headline": "Prices climb every year; your pay freezes, leaps once to catch up, then freezes again - each leap starting from a deeper hole, so the gap compounds over a career (~11% less buying power by the next contract). And here's the trap: because pay stays frozen at the old rate until a new deal is signed, every month the Company drags out the next negotiation SAVES them money - so the gap itself gives them an incentive to stall. The one fix that removes that incentive - guaranteed retro pay back to the amendable date - is not in this deal.",
    ...
    },
    {
      ...
      "shadeGap": {
        "between": [
          "Old ladder (grew to 2.16x)",
          "New ladder (only 1.61x)"
        ],
      ...
      "render": {
        ...
        "gridlines": "horizontal-only",
        "legend": "top-left",
        "emphasis": "New ladder (only 1.61x)",
        "seriesOrder": [
          "Old ladder (grew to 2.16x)",
          "New ladder (only 1.61x)"
        ]
  ...
  "marketCards": [
    ...
    },
    {
      ...
      "body": "The pay raise must be read in relative terms. Absolute: every rung up ~10%, career dollars ~+12% - looks like a clear win. Relative (the real story): the OLD scale multiplied your pay to 2.16x your start over a career; the NEW flat-bottom scale reaches only 1.61x - a permanent ~25% flattening of the progression curve, concentrated entirely in years 0-3 (raises of +5.3%/+18.8%/+7.4% replaced by 0%/0%/0%) and never recovered. This hits ONLY future hires (current staff banked the old early raises), so it's a downgrade to the next generation that current voters won't feel - the classic thing a union can concede cheaply. See pay_progression_relative.png.",
      "register": "pdf"
    },
    {
      "title": "Your pay outlook, from your position",
      "body": "Three graphs show what the BASE RATE alone does to real buying power from each position, one item at a time (other pay items are assessed separately): NEW HIRE - real buying power falls below hire-day level for two years (flat rungs + sub-inflation raises), recovers at the year-3 step, +4.5% by 2031. MID-CAREER - +6.6% by 2031, protected by longevity steps that were already owed under the old contract. SENIOR - declines every year after the catch-up, -11% by 2031, with nothing in the contract to stop it. All figures from the union's own published columns; assumptions stated on each graph.",
      "register": "pdf"
    },
    {
  ...
  "howToRead": {
    ...
    "deal_in_one_paragraph": "The 10% raise mostly just catches you back up to 2023, and the small raises after it fall behind prices - so your pay slowly loses ground. Boarding pay is the real new money, though it's really PSA catching up to what other airlines already pay. Reserve life genuinely improves, with rules you can count on. The catch that's easy to miss: they flattened the pay ladder, which costs senior FAs $10-15k a year and locks it in. And most schedule wins wait on a new bidding system that's had a rough rollout.",
  ...
  "legend": {
    "verdicts": [
      ...
      [
        "Roughly a wash",
        "gains and costs about cancel out"
      ],
      [
    ...
    "tags": [
      ...
      [
        "Market: AT STANDARD",
        "matches what comparable airlines pay"
      ],
      [
  ...
  "sections": {
    ...
    "anchors": {
      ...
      "intro": "Five principles behind every rating in this guide."
    },
    "key": {
  ...
  "tables": [
    {
      ...
      "footnote": "Defended structure = the pre-2022 relative ladder re-anchored to the new $29.77 floor. Every rung from 1 year up sits 25.5% below it - the uniform gap is the sign the raised floor was funded entirely out of the scale's shape."
    },
    {
      "id": "raise_timeline",
      "register": "both",
