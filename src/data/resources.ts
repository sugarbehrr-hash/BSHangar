...
export const contractResources: Resource[] = [
  ...
  },
  {
    ...
    links: [
      {
        label: 'Open guide',
        href: '/print/reserve-field-guide/',
        variant: 'navy',
        icon: 'ph-book-open',
      },
    ],
...
/** Printable flyer per base, keyed by the base's URL segment. */
export interface PrintFlyer {
  label: string;
  href: string;
}

export const baseFlyers: Record<string, PrintFlyer[]> = {
  clt: [
    { label: 'Meals', href: '/print/clt/meals/' },
    { label: 'Retail', href: '/print/clt/retail/' },
    { label: 'Dining', href: '/print/clt/dining/' },
  ],
  dca: [
    { label: 'Meals', href: '/print/dca/meals/' },
    { label: 'Retail', href: '/print/dca/retail/' },
    { label: 'Discounts', href: '/print/dca/discounts/' },
  ],
  dfw: [
    { label: 'Meals A/C/D', href: '/print/dfw/meals/' },
    { label: 'Discounts E/B', href: '/print/dfw/discounts/' },
  ],
  phl: [
    { label: 'Meals', href: '/print/phl/meals/' },
    { label: 'Retail', href: '/print/phl/retail/' },
    { label: 'Discounts', href: '/print/phl/discounts/' },
  ],
};
